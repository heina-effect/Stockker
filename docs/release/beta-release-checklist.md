...
- [ ] `npm run build` 성공
- [ ] `docs/release/beta-rc-gate.md`의 P0 항목이 모두 Pass 또는 출시 허용 상태
...
- [ ] 한화에어로스페이스, LS ELECTRIC, 대한광통신, 인벤티지랩, 우리로, 에스피시스템스 상세 진입 가능
...
- [ ] AI 분석 근거 소스 카드 초기 로드도 `/api/stocks/[symbol]/sources?page=1&limit=...`를 사용
...
- [ ] 대한광통신/우리로는 광통신·통신장비, 에스피시스템스는 로봇·자동화, 인벤티지랩은 바이오 섹터로 표시
